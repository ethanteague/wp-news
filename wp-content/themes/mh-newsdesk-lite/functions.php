...
if (!function_exists('mh_newsdesk_lite_widgets_init')) {
	function mh_newsdesk_lite_widgets_init() {
		register_sidebar(array('name' => esc_html__('Global Sidebar', 'mh-newsdesk-lite'), 'id' => 'sidebar', 'description' => esc_html__('Sidebar used globally throughout your site.', 'mh-newsdesk-lite'), 'before_widget' => '<div id="%1$s" class="sb-widget clearfix %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="widget-title"><span>', 'after_title' => '</span></h4>'));
