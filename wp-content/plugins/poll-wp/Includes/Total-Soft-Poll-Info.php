		...
		<tr>
	 	...
	 	<?php for( $i = 0; $i < count($Total_Soft_Poll_Info); $i++) { ?>
			<tr>
				...
				<td> <?php echo $Total_Soft_Poll_Info[$i]->IPAddress; ?> </td>
				<td> <?php echo $Total_Soft_Poll_Info[$i]->CountryName . ' (' . $Total_Soft_Poll_Info[$i]->CountryCode . ')';?> </td>
				<td> <?php echo $Total_Soft_Poll_Info[$i]->Region; ?> </td>
				<td> <?php echo $Total_Soft_Poll_Info[$i]->City; ?> </td>
				<td> <img src="<?php echo $Total_Soft_Poll_Info[$i]->CountryFlag;?>"> </td>
			</tr> 
		<?php } ?>	
 	</table>
</form>