...
<tr valign="top">
	<th scope="row">
		<label for="hseparator"><?php _e( 'Custom Search Engine ID', 'mpt' ); ?></label>
	</th>
	<td>
		<input type="text" name="MPT_plugin_settings[googleimage][cxid]" value="<?php echo( isset( $options['googleimage']['cxid'] ) && !empty( $options['googleimage']['cxid'] ) )? $options['googleimage']['cxid']: ''; ?>" >
	</td>
</tr>
<tr valign="top">
	<th scope="row">
		<label for="hseparator"><?php _e( 'Google API Key', 'mpt' ); ?></label>
	</th>
	<td>
		<input type="text" name="MPT_plugin_settings[googleimage][apikey]" value="<?php echo( isset( $options['googleimage']['apikey'] ) && !empty( $options['googleimage']['apikey']) )? $options['googleimage']['apikey']: ''; ?>" >
	</td>
</tr>
