...
<tr valign="top">
	<th scope="row">
		<label for="hseparator"><?php _e( 'Pixabay username', 'mpt' ); ?></label>
	</th>
	<td>
		<input type="text" name="MPT_plugin_settings[pixabay][username]" value="<?php echo( isset( $options['pixabay']['username'] ) && !empty( $options['pixabay']['username']) )? $options['pixabay']['username']: ''; ?>" >
	</td>
</tr>
<tr valign="top">
	<th scope="row">
		<label for="hseparator"><?php _e( 'Api key', 'mpt' ); ?></label>
	</th>
	<td>
		<input type="text" name="MPT_plugin_settings[pixabay][apikey]" value="<?php echo( isset( $options['pixabay']['apikey'] ) && !empty( $options['pixabay']['apikey']) )? $options['pixabay']['apikey']: ''; ?>" >
	</td>
</tr>
